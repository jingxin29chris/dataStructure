...
//  In this program:
//  Stack is used to implement the undo delete function in main
...
/**~*~*
 Member function getCount returns number of element
 in stack.
 *~**/
template <class T>
...
/**~*~*
 Member function getTop returns boolean, and get the top
 value in item.
 *~**/
template <class T>
